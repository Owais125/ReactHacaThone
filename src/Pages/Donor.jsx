...
const dispatch = useDispatch()
 ...
 const change_handle = (e) => {
  ...
  <div className="card-body">
    <h2 className="card-title">Blood Donor Details</h2>
    <p>Name:{data.name}</p>
      ...
      <div>
        ...
        <div className='flex justify-center items-center '>
          ...
          <div className="border-4 rounded border-violet-500 w-6/12 relative flex flex-col p-4 rounded-md text-black bg-white">
            ...
            <div className="text-sm font-normal mb-4 text-center text-[#1e0e4b]"><h1 className='text-2xl font-bold'>Blood Donation Form</h1></div>
