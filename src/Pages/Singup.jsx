  ...
  return (
    <div>
      <div className='flex justify-center items-center '>
        ...
        <div className="border-4 rounded border-violet-500 w-6/12 relative flex flex-col p-4 rounded-md text-black bg-white">
          <div className="text-2xl font-bold mb-2 text-[#1e0e4b] text-center">Welcome to the <span className="text-[#7747ff]">App</span></div>
          ...
          <div className="text-sm text-center mt-[1.6rem]">Do you have an account yet? <a className="text-sm text-[#7747ff]" href="#">Login</a></div>
        </div>
