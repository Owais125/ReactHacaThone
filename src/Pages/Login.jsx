...
const Login = () => {
  ...
  return (
    <div className='flex justify-center items-center '>
      ...
      <div className="border-4 rounded w-6/12 border-violet-500 max-w-md relative flex flex-col p-4 rounded-md text-black bg-white">
...
<div className="text-sm text-center mt-[1.6rem]">Dont have an account yet? <a className="text-sm text-[#7747ff]" href="#">SignUp</a></div>
</div>
